    ...
    <div class="row">
        <form action="/posts/{{$post->id}}" method="POST" enctype="multipart/form-data">
            <div class="col-md-8">
                ...
                <h4><span class="label label-default download-video col-md-offset-1 col-md-4" style="display: block"></span></h4>
                <h4><span class="label label-default download-pic col-md-offset-1 col-md-4" style="display: block"></span></h4>
                <br>
